...
typedef NS_ENUM(NSUInteger, TYLimitedTextFieldType) {
    ...
    TYLimitedTextFieldTypeNumber,           //数字 带小数点
    ...
    TYLimitedTextFieldTypeNum,                //纯数字
    TYLimitedTextFieldTypeEOS,              //a-z 1-5 .
    TYLimitedTextFieldTypeEOSSearch,              //a-z 1-5 .
    TYLimitedTextFieldTypeEOSNoPoint,       //az 1-5
};
